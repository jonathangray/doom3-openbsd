...
#define _alloca16( x )					((void *)((((ssize_t)_alloca( (x)+15 )) + 15) & ~15))
...
#define _alloca16( x )					((void *)((((ssize_t)alloca( (x)+15 )) + 15) & ~15))
...
#ifdef __i386__
	#define	BUILD_STRING				"openbsd-x86"
	#define BUILD_OS_ID					3
	#define CPUSTRING					"x86"
	#define CPU_EASYARGS				1
#elif defined(__amd64__)
	#define	BUILD_STRING				"openbsd-amd64"
	#define BUILD_OS_ID					3
...
public:
	...
	virtual ssize_t				DLL_Load( const char *dllName ) = 0;
	virtual void *			DLL_GetProcAddress( ssize_t dllHandle, const char *procName ) = 0;
	virtual void			DLL_Unload( ssize_t dllHandle ) = 0;
