...
public:
	...
	virtual ssize_t				DLL_Load( const char *dllName );
	virtual void *			DLL_GetProcAddress( ssize_t dllHandle, const char *procName );
	virtual void			DLL_Unload( ssize_t dllHandle );
