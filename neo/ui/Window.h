...
public:
	...
	ssize_t  GetWinVarOffset( idWinVar *wv, drawWin_t *dw );
...
protected:
	...
	int EmitOp( ssize_t a, ssize_t b, wexpOpType_t opType, wexpOp_t **opp = NULL );
	int ParseEmitOp( idParser *src, ssize_t a, wexpOpType_t opType, int priority, wexpOp_t **opp = NULL );
